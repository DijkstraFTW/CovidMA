    ...
    function render() {
        ...
        data.forEach(function(point, i) {
            if (i <= progressDots) {
                ...
                context.fillStyle = point.future ? '#aaa' : '#222';
...
function reset() {
    chart.populate([
        ...
        { label: 'Ten', value: 900 },
        { label: 'Eleven', value: 1200 },
        { label: 'Twelve', value: 1700 },
        { label: 'Eleven', value: 1200 },
        { label: 'Eleven', value: 500 },
        { label: 'Eleven', value: 1700 },
        { label: 'Eleven', value: 500 },
        { label: 'Eleven', value: 1200 },
        { label: 'Eleven', value: 1700 },
        { label: 'Eleven', value: 500 },
